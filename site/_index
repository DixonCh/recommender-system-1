<?php
	...
	$n = (isset($_GET["i"]))? $_GET["i"] : 10;
 	...
 	if(!empty($f)) {
?><div id="wrapper"><div id="content"><div id="header"><div class="head">Head</div><br><div>Showing <?php echo($n); ?> Movies &middot; <a href="?i=50">50</a> &middot; <a href="?i=100">100</a> &middot; <a href="?i=200">200</a> &middot; <a href="?i=500">500</a> &middot; <a href="?i=1000">1000</a> <?php if(!empty($usrid)) {?>&middot; <a href="profile">My Ratings</a> &middot; <a href="login?out">Logout</a> <?php } ?></div></div><div id="list"><?php
		...
		} else { echo "Start by rating films you have watched.";}?></div>
		<?php
		}
 	} else {
 		echo <<<EOT
